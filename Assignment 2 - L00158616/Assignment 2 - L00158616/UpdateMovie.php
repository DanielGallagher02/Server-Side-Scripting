...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Update.php" method="POST">
        ...
        <input type="text" name="MovieStart" class="form-control" value="Enter when the movie starts (00:00:00)">   
        </div>
        <div class="form-group">
        <label>Movie Length</label>
        <input type="text" name="MovieLength" class="form-control" value="Enter your movies Length (00:00:00)">
        </div>
        <div class="form-group">
